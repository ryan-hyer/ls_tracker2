...
RSpec.describe StandardsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all standards as @standards" do
      ...
      expect(assigns(:standards)).to eq([standard])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new standard as @standard" do
      ...
      expect(assigns(:standard)).to be_a_new(Standard)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created standard as @standard" do
        post :create, {:standard => valid_attributes}, valid_session
        expect(assigns(:standard)).to be_a(Standard)
        expect(assigns(:standard)).to be_persisted
      end

      it "redirects to the created standard" do
        post :create, {:standard => valid_attributes}, valid_session
        expect(response).to redirect_to(Standard.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved standard as @standard" do
        post :create, {:standard => invalid_attributes}, valid_session
        expect(assigns(:standard)).to be_a_new(Standard)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested standard" do
        standard = Standard.create! valid_attributes
        put :update, {:id => standard.to_param, :standard => new_attributes}, valid_session
        standard.reload
      ...
      it "redirects to the standard" do
        standard = Standard.create! valid_attributes
        put :update, {:id => standard.to_param, :standard => valid_attributes}, valid_session
        expect(response).to redirect_to(standard)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the standard as @standard" do
        standard = Standard.create! valid_attributes
        put :update, {:id => standard.to_param, :standard => invalid_attributes}, valid_session
        expect(assigns(:standard)).to eq(standard)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the standards list" do
      standard = Standard.create! valid_attributes
      delete :destroy, {:id => standard.to_param}, valid_session
      expect(response).to redirect_to(standards_url)
    end
  end
